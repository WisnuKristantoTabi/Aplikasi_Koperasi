...
<table class="m-4 mt-5">
       ...
       <tr>
           <td><a class="btn btn-warning" href="/member-view-ubah?m={{$user->mti}}">Ubah </a></td>
       </tr>
</table>
        ...
        <div class="table-responsive">
            <div class="container table-wrapper-scroll-y my-custom-scrollbar">
                 <table class="table table-bordered table-striped mb-0">
                    ...
                    <tbody>
                    @if(empty($pinjaman[0]))
                    <tr > <th class="text-center font-weight-bold text-body" colspan="5"> Data Tidak Ditemukan </th></tr>
                    @else
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Tabel Riwayat Simpanan</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <div class="container table-wrapper-scroll-y my-custom-scrollbar">
                <table class="table table-bordered table-striped mb-0">
                    <thead>
                        <tr>
                            <th scope="col" class="text-center font-weight-bold text-body"> Tanggal </th>
                            <th scope="col" class="text-center font-weight-bold text-body">Jenis Simpanan </th>
                            <th scope="col" class="text-center font-weight-bold text-body">Nomor Bukti</th>
                            <th scope="col" class="text-center font-weight-bold text-body">Saldo</th>
                        </tr>
                    </thead>
                    <tbody>
                @if($simpanan[0] == null)
